...
const NUM_START = 2; // you can tweak this
...
function spawn() {
  ...
  agents.push(new Agent(0, 0, sz, speedX, speedY));
}
...
class Agent {
  constructor(x, y, sz, speedX, speedY) {
    ...
    // Lifespan (optional)
    this.life = 350;
    // use this if you want fade/shrink/remove behavior
  }
  ...
  update() {
    ...
    // Or use a lifespan:
    this.life -= 0.5; // fade over time
    this.sz -= 0.05;
    this.a -= 0.5; // shrink slowly
  }
